...
<main id="main ">
    ...
    <section id="about " class="about pt-5">
        <div class="section-title text-white" style="background-color: #2a2c39; padding: 20px; padding-top: 28px;">
            <p style="color: white;">Blogs by Students</p>
            <h5 style="color: white;">Manage Alumni Blogs to spread students knoweledge</h5>
        </div>
        ...
        <div class="container py-3 ">
                        ...
                        <table class="table table-hover text-center align-middle table-striped table-bordered border-secondary table-sm caption-top  ">
                            ...
                            <tbody class="font-weight-bold">
                                ...
                                <?php foreach ($data as $d) : ?>
                                    <tr>
                                        <td> <?= $d['BL_Title'] ?> </td>
                                        <td> <?= word_limiter($d['BL_Description'], 10); ?> </td>
                                        <td> <?= $d['BLC_Title'] ?> </td>
                                        <td> <?= $d['St_RegNo'] ?> </td>
                                        <td> <?= $d['St_Name'] ?> </td>
                                        <td> <?= date_format(date_create($d['BL_CreatedAt']), "M jS, Y G:i")  ?> </td>
                                        <td> <?= ($d['BL_isPDF'] == '1') ? 'Yes' : 'No' ?> </td>
                                        <td>
                                            <div class="modal-footer" style="border: none;">
                                                <a class="text-success " style="cursor: pointer;" href="<?= site_url('Admin/approveBlog/' . $d['BL_Id'] . '') ?>"> <span class="fas fa-check fa-lg"></span>
                                                </a>
                                                <span class="dropdown dropup px-1 px-md-0">
                                                    ...
                                                    <ul class="dropdown-menu col-12" style=" box-shadow: 0 1px 2px 0 rgb(60 64 67 / 30%), 0 2px 6px 2px rgb(60 64 67 / 15%); border-radius: 0.5rem;" aria-labelledby="dropdownMenu2">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?= site_url('Admin/deleteBlog/' . $d['BL_Id'] . '/') ?>" class="btn btn-outline-danger">Yes</a>
            ...
            <?php else : ?>
                <div class="container text-center py-2">
                    <h2> ✅ No Blos requests are approval awaiting</h2>
                </div>
