            ...
            <div class="row row-cols-1  row-cols-md-3 g-4">
                <div class="col ">
                    <div class="card h-100">
                        <div class="card-body cont ">
                            ...
                            <p class="card-text">Approve and Delete the blogs posted by our students</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Admin/blogs') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col ">
                    <div class="card h-100">
                        ...
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Admin/termProject') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            <h4 class="card-title">Alumni Management</h4>
                            <p class="card-text">View and approve the requests of Alumni</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url("Admin/alumni") ?>" class="btn btn-primary" type="button">View Details </a>
                        </div>
                    </div>
                </div>
                <div class="col">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text">Add new notices, view current notices boards mangages them</p>
                        </div>
                        <div class="card-footer text-center">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text">Manages current FYPs and see students progess and previous FYP</p>
                        </div>
                        <div class="card-footer text-center">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text">Manage department staff</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Admin/staff') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Admin/suggestion') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
            </div>
