...
<div id="" class="my-3 mx-3">
    ...
    <div class="LoginContainer container" style="box-shadow:1px 1px 7px 3px rgb(160, 159, 159);">
        <?= form_open(site_url("Student/savePdfBlog"), ['enctype' => 'multipart/form-data']) ?>
        ...
        <div class="col-md-9 col-10 mx-auto " style="padding: 0;">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <div class="input-group ">
                            <input type="file" class="form-control  pt-2" id="blog" style="font-size: 16px; height: 42px;" name="blog">
                            <label class="input-group-text text-white " style="background-color: #e46e29; " for="blog">Blog File</label>
                        </div>
                        <p class="text-danger">
                            <?php echo getErrorMessage('errors', 'BL_Content'); ?>
                        </p>
                    </div>
                </div>
