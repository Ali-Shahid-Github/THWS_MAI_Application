            ...
            <div class="row row-cols-1  row-cols-md-3 g-4">
                <div class="col ">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont ">
                            ...
                            <p class="card-text text-truncate">Notices Notices Notices Notices </p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Faculty/notices') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer text-center">
                        <a href="<?= site_url('Faculty/profile') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text text-truncate">Manage Research details</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Faculty/research') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text text-truncate">Manage FYP, Give remarks and view submisions</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Faculty/fyp') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
