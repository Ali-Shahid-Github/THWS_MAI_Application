                ...
                <div class="col ">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont ">
                            ...
                            <p class="card-text text-truncate">Daily Routine blogs related to CS Community</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Staff/notices') ?>"><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col ">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont ">
                            ...
                            <p class="card-text text-truncate">Add and View your Term or self pace projects </p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Staff/events') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text text-truncate">View and approve the requests of Alumni</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Staff/slider') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text text-truncate">Manges Faculty profiles and add new.</p>
                        </div>
                        <div class="card-footer text-center">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            ...
                            <p class="card-text text-truncate">Approve, Add new job vacancies</p>
                        </div>
                        <div class="card-footer text-center">
                        <a href="<?= site_url('Staff/alumni') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Staff/faculty') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body cont">
                            <h5 class="card-title">FYP</h5>
                            <p class="card-text text-truncate">Approve, Add new job vacancies adsf adf ad f adsf adfa df adf daf s asdf adf a f af a f af as df </p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="<?= site_url('Staff/fyp') ?> "><button class="btn btn-primary" type="button">View Details </button> </a>
                        </div>
                    </div>
                </div>
