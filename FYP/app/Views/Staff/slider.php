...
<main id="main ">
    ...
    <section id="about " class="about pt-5">
        <div class="section-title text-white" style="background-color: #2a2c39; padding: 20px; padding-top: 28px;">
            ...
            <h5 style="color: white;">Manage Your Slider Content here</h5>
        </div>
        ...
        <div class="container py-3 ">
            <div class="row py-2">
                <div class="text-center ">
                    <a href=" <?= site_url("Staff/addSlider") ?> " class="btn btn-info  py-3 " type="button">
                        Add Slider <span class="fas fa-plus px-2 fa-lg"></span></a>
                </div>
            </div>
                        ...
                        <table class="table table-hover text-center align-middle table-striped table-bordered border-secondary table-sm caption-top  ">
                            ...
                            <tbody class="font-weight-bold">
                                ...
                                <?php foreach ($data as $d) : ?>
                                    ...
                                    <tr id="sl_<?= $d['SL_Id'] ?>">
                                        <td>
                                            <img loading="lazy" src="<?= site_url($d['SL_Image']) ?>" alt="avatar" width="250" class="thumbnail" />
                                        </td>
                                        <td><?= $d['SL_Title'] ?></td>
                                        <td><?= $d['SL_Desc'] ?></td>
                                        ...
                                        <td>
                                            <div class="modal-footer" style="border: none;">
                                                <a class="text-success " style="cursor: pointer;" onclick="editSlider('<?= $d['SL_Id'] ?>')"> <span class="fas fa-pencil-alt fa-lg"></span>
                                                </a>
                                                ...
                                                <span class="dropdown dropup px-1 px-md-0">
                                                    ...
                                                    <ul class="dropdown-menu col-12" style=" box-shadow: 0 1px 2px 0 rgb(60 64 67 / 30%), 0 2px 6px 2px rgb(60 64 67 / 15%); border-radius: 0.5rem;" aria-labelledby="dropdownMenu2">
                                                        ...
                                                        <div class="p-3">Are You Sure to Delete: <?= $d['SL_Title'] ?> ?</div>
                                                        <div class="modal-footer">
                                                            <a href="<?= site_url('Staff/deleteSlider/' . $d['SL_Id'] . '/') ?>" class="btn btn-outline-danger">Yes</a>
